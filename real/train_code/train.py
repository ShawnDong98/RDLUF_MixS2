...
def load_mask(path):
    ...
    return mask_3d_shift.unsqueeze(0)

HR_HSI_test = prepare_data(opt.test_data_path, 5)
mask_3d_shift_test = load_mask(opt.test_mask_path)
...
def train():
    ...
    logger.info('epcoh = %4d , loss = %.10f , time = %4.2f s' % (epoch, epoch_loss, elapsed_time))
