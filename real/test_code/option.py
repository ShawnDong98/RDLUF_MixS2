...
parser.add_argument('--data_path', default='../../datasets/TSA_real_data/Measurements/', type=str,
                    help='path of data')
...
parser.add_argument("--upside", default=False, type=bool, help='mask side')
