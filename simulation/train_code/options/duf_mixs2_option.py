...
def merge_duf_mixs2_opt(parser):
    ...
    parser.add_argument('--stage_interaction', type=bool, default=False, help='whether use stage interaction')
    parser.add_argument('--block_interaction', type=bool, default=False, help='whether use block interaction')
    ...
    parser.add_argument('--body_share_params', type=int, default=0, help="whether stage body share parameters")
